-- Ported Neon migration.
-- Source: migration-backups/build-in-public-studio/schema-2026-05-26.sql
-- Ported: 2026-05-26 (RLS ENABLE lines removed; Neon has no service-role concept).
